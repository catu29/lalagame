...
class BGM {
  ...
  static get currentTrack => _currentTrack;

  static set currentTrack(int index) {
    if (index < 0) {
      return;
    }
  ...
  static Future<void> add(String filename) async {
    ...
    await newTrack.fixedPlayer.setVolume(.25);
  ...
  static void setVolume(double volume) async {
    ...
    _tracks[_currentTrack].fixedPlayer.setVolume(volume);
  }
